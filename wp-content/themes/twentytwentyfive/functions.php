...
add_action('init', function() {
    // Definimos los orígenes según el entorno
    $allowed_origins = ['https://onda.pe', 'https://www.onda.pe'];

    // Si estamos en desarrollo, permitimos localhost
    if (isset($_SERVER['REMOTE_ADDR']) && in_array($_SERVER['REMOTE_ADDR'], ['127.0.0.1', '::1'])) {
        $allowed_origins[] = 'http://localhost:3005'; // Por si usas este puerto
    }
